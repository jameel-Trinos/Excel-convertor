...
class PartyNameFixer:
    ...
    REVERSED_PARTY_PATTERNS: Dict[str, str] = {
        ...
        # Character-level reversals (MAKKAL->LAKKAM, NAADAALUM->MULAADAAN, KATCHI->IHCTAK)
        "LAKKAM MULAADAAN IHCTAK": "MAKKAL NAADAALUM KATCHI",
        "IHCTAK MULAADAAN LAKKAM": "MAKKAL NAADAALUM KATCHI",  # User reported pattern
        "MULAADAAN LAKKAM IHCTAK": "MAKKAL NAADAALUM KATCHI",
        "MULAADAAN IHCTAK LAKKAM": "MAKKAL NAADAALUM KATCHI",
        "LAKKAM IHCTAK MULAADAAN": "MAKKAL NAADAALUM KATCHI",
        "IHCTAK LAKKAM MULAADAAN": "MAKKAL NAADAALUM KATCHI",
        # Word-order reversals
