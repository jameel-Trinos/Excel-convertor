...
class OCRTableParser:
    ...
    def parse_election_form20(
        ...
        if bounding_boxes:
            table_data = self._parse_from_bounding_boxes(bounding_boxes, page_number)
    ...
    def _parse_from_bounding_boxes(
        ...
        Groups text by Y-coordinate to form rows and X-coordinate for columns.
        ...
        if any(b.line_num > 0 for b in boxes):
            ...
            rows = self._group_by_y_coordinate(boxes)
